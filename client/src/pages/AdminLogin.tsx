  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    try {
      ...
      if (password === ADMIN_PASSWORD) {
        // Set a short-lived authentication flag (will be cleared on page refresh/navigation)
        // This is just for the immediate redirect to work
        ...
        // Clear the authentication after a short delay (just to be extra sure)
        setTimeout(() => {
